...
import { getPurchaseOrders, createPurchaseOrder, updatePurchaseOrder, PurchaseOrder } from '@/lib/services/resourceService';
            ...
            <tbody>
              {pos.map(po => (
                <tr key={po.id}>
                  ...
                  <td><button className={styles.actionSelect} onClick={() => openModal(po)}>Edit</button></td>
                </tr>
              ))}
